...
def telemetry(sid, data):
    ...
    try:
        if data:
            ...
            if np.isfinite(Rover.vel):
                ...
                if Rover.send_pickup and not Rover.picking_up:
                    ...
                    _send_control(commands, out_image_string1, out_image_string2)
        ...
        print("Catch exception in main loop %s " % e)
        traceback.print_exc()
...
def _send_control(commands, image_string1, image_string2):
...
if __name__ == '__main__':
    ...
    if args.image_folder != '':
        # logger.info("Creating image folder at {}".format(args.image_folder))
